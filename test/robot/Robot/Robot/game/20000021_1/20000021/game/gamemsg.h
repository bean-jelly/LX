...
//定时器
#define	   GAME_TIME_CALL_SCORE			  10002102
#define	   GAME_TIME_ROB_NT				  10002103
#define    GAME_TIME_ADD_DOUBLE			  10002104
#define	   GAME_TIME_OUT_CARD			  10002105				//出牌定时器
...
typedef struct sc_user_agree_i
{
	...
	sc_user_agree_i()
	{
		memset(b_agree, false, sizeof(b_agree));
		bytime = 0;
	}
}user_agree_i;
